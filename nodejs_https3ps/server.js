...
app.get('/', function (req, res) {
  res.send('Health check path / accessed for this app!!..')
  var logger  = lawgs.getOrCreate('fgnodejsloggroup'); /* LogGroup */
  logger.log('lawgshclogs', { team: 'apple Health check', weight: 1 });
})
...
.listen(3022, function () {
  console.log('Example app listening on port 3022! Go to https://localhost:3022/')
})
